...
namespace Vistas.Common
{
    /// <summary>
    /// SuspensionManager captura el estado de sesión global para simplificar la administración del ciclo de vida de los procesos
    /// de una aplicación. Tenga en cuenta que el estado de la sesión se borrará automáticamente bajo diversas
    /// condiciones y solamente debería usarse para almacenar información que conviene
    /// preservar entre sesiones, pero que se debe descartar cuando la aplicación se bloquee o se
    /// actualice.
    /// </summary>
    internal sealed class SuspensionManager
    {
        ...
        /// leer y escribir el estado de la sesión.  Inicialmente vacía, pueden agregarse tipos adicionales
        /// para personalizar el proceso de serialización.
        /// </summary>
