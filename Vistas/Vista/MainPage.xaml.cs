...
namespace Vistas
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        /// </summary>
        /// <param name="sender">
        /// Origen del evento; generalmente, <see cref="Common.NavigationHelper"/>
        /// </param>
        ...
        /// requisitos de <see cref="Common.SuspensionManager.SessionState"/>.
        /// </summary>
        /// <param name="sender">Origen del evento; generalmente <see cref="Common.NavigationHelper"/></param>
        ...
        {
            this.Frame.Navigate(typeof(Presentacion.UsuarioPage));
        }
    }
}
